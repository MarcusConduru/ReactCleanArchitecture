...
describe('Login', () => {
  ...
  it('Should present valid state if form is valid', () => {
    ...
    cy.getByTestId('email').should('not.have.attr','title','Tudo certo!')
    cy.getByTestId('email-label').should('not.have.attr','title','Tudo certo!')
    cy.getByTestId('password').focus().type(faker.internet.email())
    cy.getByTestId('password-wrap').should('have.attr','data-status', 'valid')
    cy.getByTestId('password').should('not.have.attr','title','Tudo certo!')
    cy.getByTestId('password-label').should('not.have.attr','title','Tudo certo!')
